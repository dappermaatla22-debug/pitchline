var TEAM_COLORS = {
  ...
  'Mexico': {bg:'#006847',fg:'#fff',flag:'mx'}, 'Canada': {bg:'#FF0000',fg:'#fff',flag:'ca'},
  'Ecuador': {bg:'#FFD100',fg:'#000',flag:'ec'}, 'Senegal': {bg:'#00853E',fg:'#fff',flag:'sn'},
  'Cameroon': {bg:'#007A5E',fg:'#fff',flag:'cm'}, 'Ghana': {bg:'#CE1126',fg:'#fff',flag:'gh'},
  'Tunisia': {bg:'#E70013',fg:'#fff',flag:'tn'}, 'Iran': {bg:'#239F40',fg:'#fff',flag:'ir'},
  'Saudi Arabia': {bg:'#006C35',fg:'#fff',flag:'sa'}, 'South Korea': {bg:'#003478',fg:'#fff',flag:'kr'},
  'Poland': {bg:'#DC143C',fg:'#fff',flag:'pl'}, 'Serbia': {bg:'#C6363C',fg:'#fff',flag:'rs'},
  'Morocco': {bg:'#C1272D',fg:'#fff',flag:'ma'}, 'Uruguay': {bg:'#5FC2DA',fg:'#000',flag:'uy'},
  'Croatia': {bg:'#171796',fg:'#fff',flag:'hr'}, 'Peru': {bg:'#D91023',fg:'#fff',flag:'pe'},
  'Colombia': {bg:'#FCD116',fg:'#000',flag:'co'}, 'Chile': {bg:'#D52B1E',fg:'#fff',flag:'cl'},
  'Paraguay': {bg:'#D52B1E',fg:'#fff',flag:'py'}, 'Bolivia': {bg:'#007934',fg:'#fff',flag:'bo'},
  'Venezuela': {bg:'#CF142B',fg:'#fff',flag:'ve'}, 'Indonesia': {bg:'#FF0000',fg:'#fff',flag:'id'},
  'Algeria': {bg:'#006233',fg:'#fff',flag:'dz'}, 'Nigeria': {bg:'#008751',fg:'#fff',flag:'ng'},
  'Mali': {bg:'#14B53A',fg:'#fff',flag:'ml'}, 'Burkina Faso': {bg:'#009E49',fg:'#fff',flag:'bf'},
  'DR Congo': {bg:'#007FFF',fg:'#fff',flag:'cd'}, 'Guinea': {bg:'#CE1126',fg:'#fff',flag:'gn'},
  'Zambia': {bg:'#198A38',fg:'#fff',flag:'zm'}, 'Cape Verde': {bg:'#003893',fg:'#fff',flag:'cv'},
  'Gabon': {bg:'#009E60',fg:'#fff',flag:'ga'}, 'Uganda': {bg:'#FCDC04',fg:'#000',flag:'ug'},
  'Iceland': {bg:'#003897',fg:'#fff',flag:'is'}, 'Wales': {bg:'#00AB39',fg:'#fff',flag:'gb-wls'},
  'Scotland': {bg:'#003078',fg:'#fff',flag:'gb-sct'}, 'Norway': {bg:'#BA0C2F',fg:'#fff',flag:'no'},
  'Sweden': {bg:'#006AA7',fg:'#fff',flag:'se'}, 'Denmark': {bg:'#C8102E',fg:'#fff',flag:'dk'},
  'Austria': {bg:'#ED2939',fg:'#fff',flag:'at'}, 'Czech Republic': {bg:'#11457E',fg:'#fff',flag:'cz'},
  'Hungary': {bg:'#477050',fg:'#fff',flag:'hu'}, 'Romania': {bg:'#002B7F',fg:'#fff',flag:'ro'},
  'Ukraine': {bg:'#FFD500',fg:'#000',flag:'ua'}, 'Greece': {bg:'#0D5EAF',fg:'#fff',flag:'gr'},
